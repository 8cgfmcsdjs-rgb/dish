...
const DJILEN_PRODUCTS = [
  // ---------------- VARSITY JACKETS ----------------
  { id:'vj-01', name:'Origin Varsity Jacket', dept:'men', type:'varsity-jackets', price:465, tint:'olive-ink', badge:'New', desc:'Wool body, leather sleeves, chest-embroidered DJ monogram with the signature diagonal opening.' },
